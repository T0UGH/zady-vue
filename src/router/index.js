    ...
    children: [
      {
        ...
        name: 'Menu1',
        meta: { title: 'Menu1', roles: ['master', 'owner'] },
        children: [
          {
            path: 'menu1-1',
            component: () => import('@/views/nested/menu1/menu1-1'),
            name: 'Menu1-1',
            meta: { title: 'Menu1-1', roles: ['master', 'owner'] }
          },
          {
            path: 'menu1-2',
            component: () => import('@/views/nested/menu1/menu1-2'),
            name: 'Menu1-2',
            meta: { title: 'Menu1-2', roles: ['master', 'owner'] },
            children: [
              {
                path: 'menu1-2-1',
                component: () => import('@/views/nested/menu1/menu1-2/menu1-2-1'),
                name: 'Menu1-2-1',
                meta: { title: 'Menu1-2-1', roles: ['master', 'owner'] }
              },
              {
                path: 'menu1-2-2',
                component: () => import('@/views/nested/menu1/menu1-2/menu1-2-2'),
                name: 'Menu1-2-2',
                meta: { title: 'Menu1-2-2', roles: ['master', 'owner'] }
              }
            ]
          },
          {
            ...
            name: 'Menu1-3',
            meta: { title: 'Menu1-3', roles: ['master', 'owner'] }
          }
        ]
      },
      {
        ...
        meta: { title: 'menu2', roles: ['master', 'owner'] }
      }
    ]
  },
